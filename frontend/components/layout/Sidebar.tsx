...
import { LayoutDashboard, AlertTriangle, AreaChart, Wrench, Bot, SlidersHorizontal, Settings, X, Bolt, Share2, Building, HardDrive } from 'lucide-react';
      ...
      >
        <div className="flex items-center justify-between p-4 h-16 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <img src="/logo.jpeg" className="w-8 h-8" alt="" />
            <span className="text-xl font-bold text-gray-900 dark:text-white ml-2">Urja Grid</span>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
